...
export const siteContent: Record<Locale, PersonalSiteContent> = {
  vi: {
    ...
    bio: {
      ...
      quote:
        "Kiến thức là tự do và sự ngu dốt là ngục tù. Ai cũng có thể chơi nhạc. Nốt nhạc chỉ chiếm 20 phần trăm. Thái độ của kẻ chơi nhạc mới chiếm 80 phần trăm.",
      facts: [
      ...
      tracks: [
        {
          ...
          year: "2026",
          platform: "Coming soon",
          description: "A simulated track for the moment a red signal starts breathing.",
          href: "#",
        },
        {
          title: "Late Packet",
          ...
          year: "2026",
          platform: "Coming soon",
          description: "Slow, dark, and feels like a packet arriving late but just in time.",
          href: "#",
        },
        {
          title: "Static Bloom",
          ...
          year: "2026",
          platform: "Coming soon",
          description: "A small pocket of static blooming into a melody.",
          href: "#",
        },
      ],
    },
  ...
  zh: {
    ...
    bio: {
      ...
      quote: "知识即自由，无知即奴役。任何人都可以演奏。音符只占百分之二十。演奏者的态度才占百分之八十。",
      facts: [
        { label: "所在地", value: "越南" },
